  ...
  <div className="about-container">
    ...
    <section className="about">
      <article>
        ...
        <br />
        <br />
        <br />I have almost 4 years of experience building production applications with Ruby/Ruby on
        Rails and Javascript at companies such as <a href="https://www.andela.com"> Andela </a>,
